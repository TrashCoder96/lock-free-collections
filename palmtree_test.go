...
func checkLeafNode(keys []int64, node *palmNode, t *testing.T) {
...
func checkInternalNode(keys []int64, node *palmNode, t *testing.T) {
...
func initOneTestLeafNode(countOfKeys int, base int64, step int64) *palmNode {
	value := int64(base)
	node := palmNode{
		isLeaf:      true,
...
func initOneTestLeafNodeByKeys(keys []int64) *palmNode {
	node := palmNode{
		isLeaf:      true,
...
func initOneTestInternalNodeByKeys(keys []int64) *palmNode {
	node := palmNode{
		isLeaf:      false,
		countOfKeys: len(keys),
	}
	node.internalNodeHead = &palmTreePointer{}
...
func initOneTestInternalNode(countOfKeys int, base int64, step int64) *palmNode {
	node := palmNode{
		isLeaf:      false,
		countOfKeys: countOfKeys,
	}
